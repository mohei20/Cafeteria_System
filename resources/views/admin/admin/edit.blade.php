        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics mb-30">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.update',$data['user']->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name='email' class="form-control" id="exampleInputEmail1" value="{{old('email',$data['user']->email)}}"
